...
function tableCreate() {
  ...
  for (let i = 1; i <= numCells; i++) { //стобцы
...
tableCreate();
let tablelength = document.getElementsByTagName('tr')[ZERO].children.length;
...
(function() {
  ...
  let elementsLi = document.querySelectorAll('ul > li:last-child');
